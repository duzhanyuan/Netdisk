...
// NetdiskClient.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CNetdiskClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CNetdiskClientApp construction

CNetdiskClientApp::CNetdiskClientApp()
{
...
// The one and only CNetdiskClientApp object

CNetdiskClientApp theApp;


// CNetdiskClientApp initialization

BOOL CNetdiskClientApp::InitInstance()
{
